        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {(activity.subitems || []).map((sub) => (
              <div
                key={sub.id}
                className="bg-white rounded-lg shadow-md overflow-hidden border border-amber-100 p-5"
              >
          ...
          <div className="mt-8 flex gap-3">
            ...
            <Link
              to="/contact"
              className="px-4 py-2 bg-white border border-amber-600 text-amber-600 rounded"
            >
              Join / Contact
            </Link>
          </div>
